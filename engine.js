...
class DragonTreasureConsole {
    ...
    async playBootSequence() {
        ...
        // 1. O Dragão começa a abrir o Baú (Arpejo Progressivo)
        status.textContent = "O Dragão está abrindo o Baú... (Arpejo subindo)";
        // Aqui tocaria o arpejo e o som de madeira rangendo
        await this.wait(4000);

        // 2. O Baú abre totalmente (RUGIDO + Fogo)
        status.textContent = "RUGIDO DO DRAGÃO! O fogo ilumina o tesouro.";
        // Tocar dragon_roar.mp3
        navigator.vibrate([100, 50, 500]); // Vibração forte para o rugido
        await this.wait(1000);

        // 3. A Voz da Marca
        status.textContent = "CONCEGO'S DRAGON TREASURE";
        // Tocar concegos_dragon_treasure.mp3
